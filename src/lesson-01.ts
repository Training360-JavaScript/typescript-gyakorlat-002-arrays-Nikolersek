export default class calculator {
     ...
     */
    users: {name: string, email: string}[] = [{name: "Niki", email: "kaki@hotmail.com"}, {name: "Niki", email: "kaki@hotmail.com"}]; 
     ...
     */    
    products: {name: string, price: number, stock: number, active?: boolean}[] = [{name: "Dave", price: 10, stock: 5, active: true}, {name: "Dave", price: 10, stock: 5}];
    
    /** 
     * Inicializálj egy tuple típust, azaz adj neki értéket is.
     * @type {Tuple} role - number, string, boolean. 
     */
    role: [number, string, boolean] = [5, "láv", true];
